...
function getFooter() {
  return `
  <div style="margin-top:32px;padding-top:20px;border-top:1px solid #e0e0e0;text-align:center;font-family:Georgia,serif;">
    <p style="color:#5a7a6a;font-size:13px;margin:0 0 6px;">Working for your well-being and made by <strong>Centre of Happiness</strong></p>
    <p style="color:#8aaa9a;font-size:12px;margin:0 0 4px;">
      For any query: <a href="mailto:happyness@amity.edu" style="color:#4a7c59;">happyness@amity.edu</a> &middot;
      <a href="mailto:happyness.amity@gmail.com" style="color:#4a7c59;">happyness.amity@gmail.com</a>
    </p>
    <p style="color:#8aaa9a;font-size:12px;margin:0;">Teacher's no.: +91 8447968032</p>
  </div>`;
}
